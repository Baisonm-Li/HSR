...
class DCTFormer(nn.Module):
    def __init__(self, HSI_bands, upscale_factor=4, n_feats=180):
        super(DCTFormer, self).__init__()
        kernel_size = 3
        self.up_factor = upscale_factor

        self.headX = nn.Conv2d(HSI_bands, n_feats, kernel_size, stride=1, padding=3 // 2)
        ...
        self.final = nn.Conv2d(n_feats, HSI_bands, kernel_size, stride=1, padding=3 // 2)
